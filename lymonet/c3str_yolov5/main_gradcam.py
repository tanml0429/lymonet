...
-*- coding: utf-8 -*-
@Author  : EricZ
@Time    : 2022/10/6 21:12
@Software: PyCharm
@File    : main_gradcam.py
"""
import os
import random
import time
...
# parser.add_argument('--model-path', type=str, default="runs/train/fusion_mixed10/weights/best.pt", help='Path to the model')
# parser.add_argument('--img-path', type=str, default='dataset_unpair/images/train/CDFI', help='input image path')
